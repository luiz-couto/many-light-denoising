...
set_target_properties(OpenImageDenoise_core PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageDenoise_core.2.5.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libOpenImageDenoise_core.2.5.0.dylib"
  )

list(APPEND _cmake_import_check_targets OpenImageDenoise_core )
list(APPEND _cmake_import_check_files_for_OpenImageDenoise_core "${_IMPORT_PREFIX}/lib/libOpenImageDenoise_core.2.5.0.dylib" )
...
set_target_properties(OpenImageDenoise PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageDenoise.2.5.0.dylib"
  IMPORTED_SONAME_RELEASE "@rpath/libOpenImageDenoise.2.dylib"
  )

list(APPEND _cmake_import_check_targets OpenImageDenoise )
list(APPEND _cmake_import_check_files_for_OpenImageDenoise "${_IMPORT_PREFIX}/lib/libOpenImageDenoise.2.5.0.dylib" )
